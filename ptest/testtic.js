(function() {
    ...
    var externalEventsToPlay = [
        function (page, cookie) {page.evaluate(function() {document.getElementById('b1').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b2').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b3').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b4').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b5').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b6').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b7').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b8').click()}, [], cookie);},
        function (page, cookie) {page.evaluate(function() {document.getElementById('b9').click()}, [], cookie);},
    ]
    ...
    recurseMin(shuffle(externalEventsToPlay), 0);
})();
